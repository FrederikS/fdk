...
import { HighlightInnerProps, Language } from "@lekoarts/gatsby-theme-minimal-blog/src/types"
...
const Code = ({
  ...
  if (props[`react-live`]) {
    return <LazyLiveProvider code={codeString} noInline theme={undefined} />
  }
  return (
    <LazyHighlight code={codeString} language={language} theme={undefined}>
