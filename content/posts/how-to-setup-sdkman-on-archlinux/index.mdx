...
There is one AUR package available called `sdkman` but its seems to be an unoffical sdkman client.
...
#### What is the problem? Sdkman exports the according enviroment variable.
...
### Enable the enviroment variable globally for an user
